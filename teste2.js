...
//procura jg anulado
limpResult[0] == 99 ? limpResult[0] = '196' : limpResult[0]
limpResult[1] == 99 ? limpResult[1] = '196' : limpResult[1]
limpResult[2] == 99 ? limpResult[2] = '196' : limpResult[2]
limpResult[3] == 99 ? limpResult[3] = '196' : limpResult[3]
limpResult[4] == 99 ? limpResult[4] = '196' : limpResult[4]
limpResult[5] == 99 ? limpResult[5] = '196' : limpResult[5]
limpResult[6] == 99 ? limpResult[6] = '196' : limpResult[6]
limpResult[7] == 99 ? limpResult[7] = '196' : limpResult[7]
limpResult[8] == 99 ? limpResult[8] = '196' : limpResult[8]
limpResult[9] == 99 ? limpResult[9] = '196' : limpResult[9]
//resultado parcial
limpResult.length == 5 ? limpResult.push('198', '198', '198', '198', '198', '198', '198') : limpResult
limpResult.length == 6 ? limpResult.push('198', '198', '198', '198', '198', '198') : limpResult
limpResult.length == 7 ? limpResult.push('198', '198', '198', '198', '198') : limpResult
limpResult.length == 8 ? limpResult.push('198', '198', '198', '198') : limpResult
limpResult.length == 9 ? limpResult.push('198', '198', '198') : limpResult
limpResult.length == 10 ? limpResult.push('198', '198') : limpResult
limpResult.length == 11 ? limpResult.push('198') : limpResult
//prepara o palpite
